...
import { buildEnrolmentUrl, generatePopup, handleRedirect } from "../utils";
...
const enrol = async ({
  ...
  redirectUrl,
  apiUrl = API_URL,
}: EnrolProps): Promise<EnrolmentResponse | void> => {
  if (typeof window === "undefined") {
    console.warn("ENROL_ONLY_AVAILABLE_IN_BROWSER");
